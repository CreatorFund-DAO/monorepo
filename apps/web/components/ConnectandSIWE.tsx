  ...
  if (!account.isConnected) {
    return (
      <button
        ...
        className="px-4 py-3 bg-blue-400 text-white rounded-lg hover:bg-blue-300 disabled:bg-blue-300 disabled:cursor-not-allowed font-medium transition-colors"
      >
