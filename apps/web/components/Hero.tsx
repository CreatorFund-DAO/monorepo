  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (mouse.x && mouse.y) {
        ...
        mouseGradient.addColorStop(0, 'rgba(15, 15, 15, 0.97)');
        mouseGradient.addColorStop(1, 'rgb(255, 255, 255)');
...
export default function HeroSection() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black-900 via-white-900 to-black-900 overflow-hidden">
  ...
  <div className="space-y-2">                 
    ...
    <h2 className="text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black leading-[1.1] tracking-tight text-blue-300 drop-shadow-lg">                   
    Win, License & Build IP                 
    </h2>               
  </div>               
  <div className="space-y-4 max-w-xl mx-auto">                 
    <p className="text-xl lg:text-2xl xl:text-3xl text-white-300 leading-relaxed font-medium drop-shadow-md">                   
    Decentralized lotteries for creators to raise funds .               
    </p>                 
